...
class Console(DrawableObjectInterface):
    def __calculate_character_per_line_limit(self, console_width : int):
        single_ch_width = self.font.size('aaaaa')[0]
        self.character_per_line_limit = int(5 * console_width / single_ch_width)
    ...
    def __print(self, text : str):
        line = self.font.render(text, 1, self.color, (0, 0, 0))
    ...
    def print(self, text : str):
        ...
        return self.print_nl(last_line_text + text)

    def print_nl(self, text : str):
        lines = []
