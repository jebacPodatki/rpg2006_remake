...
class CharacterPortrait(DrawableObjectInterface):
    ...
    def __init__(self, config : Config, character : Character, position = (0, 0)):
        ...
        self.img = ResourceProvider.get(self.__get_portrait_path(config, character.sheet.portrait))
        self.img_dead = ResourceProvider.get(self.__get_portrait_path(config, character.sheet.dead_portrait))
